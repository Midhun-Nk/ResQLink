...
//   }, [activeTab]);
// // Sync state if user manually changes route
// useEffect(() => {
//   const tab = location.pathname.replace("/", "").replace(/-/g, " ");
//   if (tab.length > 0) setActiveTab(tab.replace(/\b\w/g, c => c.toUpperCase()));
// }, []);
...
//       case 'Weather Alerts': return <Conference />;
      
//       // case 'Weather': return <Conference />;
...
//   <Route path="/weather-alerts" element={<Conference />} />
//   <Route path="/alerts" element={<AlertsView />} />
//   <Route path="/sos" element={<SOSView />} />
//   <Route path="/rescue-channels" element={<RescueView />} />
//   <Route path="/map-navigation" element={<PlaceholderView title="Live Map Navigation" icon={MapIcon} color="text-blue-500" />} />
//   <Route path="/donate" element={<PlaceholderView title="Donation Center" icon={Heart} color="text-pink-500" />} />
//   <Route path="/safety-info" element={<PlaceholderView title="Safety Guidelines" icon={Shield} color="text-green-500" />} />
//   <Route path="/resource-requests" element={<PlaceholderView title="Resource Requests" icon={FileText} color="text-orange-500" />} />
//   <Route path="/contacts" element={<PlaceholderView title="Emergency Contacts" icon={Phone} color="text-indigo-500" />} />
// </Routes>
// }
//         </div>
...
export default function MainLayout() {
  ...
  return (
    ...
    { id: "Resource Requests", label: "Resource Requests", icon: FileText }
          ...
          {!isMini && <div className="text-gray-400 text-xs font-bold mt-6 mb-3 uppercase px-3">Help</div>}
          {isMini && <div className="border-t w-8 mx-auto my-4"></div>}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center pl-4 border-l">
              <div className="hidden md:block text-right">
                <h6 className="font-bold text-sm">Sarah Connor</h6>
